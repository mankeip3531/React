        ...
        <div className = 'table'>
            <div class="row">
                <div className="column">
                    <h1 className = "title2 name" style = {{fontSize: "50px"}}>To stop climate change, we should stop burning fossil fuels as soon as possible.</h1>
                    <ul className = "list"> 
                ...
                <div className="column2">
                    <img src = 'https://bloombergcoalcountdown.com/wp-content/uploads/2021/02/shutterstock_605248844-1-1.jpg' alt='' width='100%'/>
                </div>
            </div>
            <div className = 'row'>
                <div className="column">
                ...
                <div className="column2">
                    <h1 className = "title2 name" style = {{fontSize: "50px"}}>Pave our road with recycle plastic</h1>
                    <ul className = "list"> 
            ...
            <div className = "row">
                <div className = "column">
                    <h1 className = "title2 name" style = {{fontSize: "50px"}}>Turn off your house applicances when you are not using it</h1>
                    <ul className = "list"> 
